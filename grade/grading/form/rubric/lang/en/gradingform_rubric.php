...
$string['weightpostfix'] = '{$a}% weight';
$string['ruleweightsum100'] = 'Weight sum should be 100%';
$string['rulescorecannotbelessthan0'] = 'Score can not be less than 0';
$string['rulescorecannotbegreaterthan10'] = 'Score can not be greater than 10';
$string['ruleallcriteriascore0points'] = 'All criteria should have score that equal 0 points';
$string['ruleallcriteriascore10points'] = 'All criteria should have score that equal 10 points';
$string['rulescoreascendingordering'] = 'Scores in every criteria should be filled in ascending ordering';
$string['rulescorestartswith0points'] = 'Score in every criteria should starts from 0 points';
$string['rulescoreendsswith10points'] = 'Score in every criteria should ends with 10 points';
$string['rulesamelevelcount'] = 'Every criteria should have the same level count';
